...
const benefits: Benefit[] = [
  ...
  },
  {
    ...
    text: 'За допомогою нашого он лайн календаря для запису на візит,  плануйте відвідування в зручний для вас час,  підлаштовуйте графік процедур під свій розклад дня. Це особливо важливо для людей, котрим важко знайти час для регулярних процедур.',
  },
  {
...
const Benefits: React.FC = () => {
  ...
  const nextSlide = () => {
    setCurrentIndex((prevIndex) => (prevIndex + 1) % (totalSlides - itemsToShow + 1));
  };
    ...
    <div className="page__benefits benefits">
      ...
      <div className="benefits__items">
        <div className="benefits__slider">
          ...
          <div className="slider__slides" style={{ transform: `translateX(-${currentIndex * (100 / itemsToShow)}%)` }} {...handlers}>
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="benefits__item benefits-item"
              >
