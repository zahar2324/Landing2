...
const Tariffs: React.FC = () => {
  ...
  const handleCardClick = (tariff: string, price:number) => {
    setSelectedPrice(price)
    setSelectedTariff(tariff);
    setIsPopupVisible(true);
    console.log(`you'w got ${tariff}`)
  };
  ...
  return (
    <>
      {isPopupVisible && <PopUp onClose={closePopup} tariff={selectedTariff} price={selectedPrice}/>}
        ...
        <div className="tariffs__slider" {...handlers}>
          ...
          >
            <div className="tariffs__items">
              <div className="tariffs__item tariffs__item-1" onClick={() => handleCardClick('Стартовий', 1200)}>
              ...
              <div className="tariffs__item tariffs__item-2" onClick={() => handleCardClick('Стандарт', 2000)}>
              ...
              <div className="tariffs__item tariffs__item-3" onClick={() => handleCardClick('Преміум', 2600)}>
              ...
              <div className="tariffs__item tariffs__item-4" onClick={() => handleCardClick('Люкс', 3200)}>
